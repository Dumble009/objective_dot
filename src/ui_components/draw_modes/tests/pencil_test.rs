...
mod test {
    ...
    fn pencil_draw_test() {
        ...
        assert_eq!(drawing.get_grid_mut().get_color(0, 0).unwrap(), 1);
        ...
        assert_eq!(drawing.get_grid_mut().get_color(0, 4).unwrap(), 1);
    ...
    fn pencil_outside_canvas_test() {
        ...
        assert_eq!(drawing.get_grid_mut().get_color(9, 9).unwrap(), 1);
